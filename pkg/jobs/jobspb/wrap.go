...
func DetailsType(d isPayload_Details) (Type, error) {
	...
	case *Payload_SstIngestDetails:
		return TypeSSTIngest, nil
	default:
...
var JobDetailsForEveryJobType = map[Type]Details{
	...
	TypeSSTIngest:                    SstIngestDetails{},
}
...
func WrapProgressDetails(details ProgressDetails) interface {
	...
	case SstIngestProgress:
		return &Progress_SstIngest{SstIngest: &d}
	default:
...
func WrapPayloadDetails(details Details) interface {
	...
	case SstIngestDetails:
		return &Payload_SstIngestDetails{SstIngestDetails: &d}
	default:
