...
var useSwapMutationsEnabled = settings.RegisterBoolSetting(
	settings.ApplicationLevel,
	"logical_replication.consumer.use_swap_mutations.enabled",
	"determines whether the consumer uses swap mutations for UPDATE operations in the table batch handler",
...
func tableHandlerSessionSettings(
	...
	sd.UseSwapMutations = useSwapMutationsEnabled.Get(&settings.SV)
