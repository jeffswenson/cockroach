...
type RowReplicator interface {
	InsertRow(ctx context.Context, row cdcevent.Row) error
	DeleteRow(ctx context.Context, row cdcevent.Row, prevRow cdcevent.Row) error
	UpdateRow(ctx context.Context, row cdcevent.Row, prevRow cdcevent.Row) error
	UpdateTombstone(ctx context.Context, row cdcevent.Row) error
}
