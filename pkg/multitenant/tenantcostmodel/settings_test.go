	...
	for _, tc := range []struct {
		...
		},
		{
			...
			input: `{"regionPairs": [
				...
				{"fromRegion": "us-west1", "toRegion": "us-west1", "cost": 0},
		...
		},
		{
			...
			input: `{"regionPairs": [
				{"fromRegion": "us-central1", "toRegion": "us-central1", "cost": -10}
			]}`,
		...
		t.Run(tc.name, func(t *testing.T) {
			err := RegionalCostMultiplierTableSetting.Validate(nil, tc.input)
			if tc.err != "" {
