		...
		if err != nil {
			...
			if br.Error == nil {
				...
				if ds.kvInterceptor != nil {
					...
					// TODO(jeffswenson): can we simplify this to an else instead of a weird ! branch?
					networkCost := ds.computeNetworkCost(ctx, desc, &curReplica, ba.IsWrite())
					if ba.IsWrite() {
...
// computeNetworkCost
// TODO(jeffswenson): document this
//
// returns the RU multiplier for a batch that is sent
...
// TODO(jeffswenson): document getReplicaRegion
