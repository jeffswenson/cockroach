...
var builtinOidsArray = []string{
	...
	2462: `workload_index_recs() -> tuple{string AS index_rec, bytes[] AS fingerprint_ids}`,
	2463: `workload_index_recs(timestamptz: timestamptz) -> tuple{string AS index_rec, bytes[] AS fingerprint_ids}`,
	...
	2713: `citextin(input: anyelement) -> citext`,
	2714: `bpchar(citext: citext) -> bpchar`,
	2715: `inet(citext: citext) -> inet`,
	2716: `varchar(citext: citext) -> varchar`,
	2717: `name(citext: citext) -> name`,
	2718: `text(citext: citext) -> string`,
	2719: `char(citext: citext) -> "char"`,
	2720: `bool(citext: citext) -> bool`,
	2721: `citext(bool: bool) -> citext`,
	2722: `citext(inet: inet) -> citext`,
	2723: `citext(text: text) -> citext`,
	2724: `citext(varchar: varchar) -> citext`,
	2725: `citext(string: string) -> citext`,
	2726: `citext(citext: citext) -> citext`,
	2727: `timestamptz(citext: citext) -> timestamptz`,
	2728: `regnamespace(citext: citext) -> regnamespace`,
	2729: `oid(citext: citext) -> oid`,
	2730: `regtype(citext: citext) -> regtype`,
	2731: `regrole(citext: citext) -> regrole`,
	2732: `regclass(citext: citext) -> regclass`,
	2733: `regproc(citext: citext) -> regproc`,
	2734: `regprocedure(citext: citext) -> regprocedure`,
	2735: `pg_lsn(citext: citext) -> pg_lsn`,
	2736: `box2d(citext: citext) -> box2d`,
	2737: `bit(citext: citext) -> bit`,
	2738: `date(citext: citext) -> date`,
	2739: `time(citext: citext) -> time`,
	2740: `timetz(citext: citext) -> timetz`,
	2741: `interval(citext: citext) -> interval`,
	2742: `decimal(citext: citext) -> decimal`,
	2743: `float8(citext: citext) -> float`,
	2744: `geography(citext: citext) -> geography`,
	2745: `varbit(citext: citext) -> varbit`,
	2746: `jsonpath(citext: citext) -> jsonpath`,
	2747: `int2(citext: citext) -> int2`,
	2748: `int4(citext: citext) -> int4`,
	2749: `float4(citext: citext) -> float4`,
	2750: `numeric(citext: citext) -> decimal`,
	2751: `uuid(citext: citext) -> uuid`,
	2752: `tsquery(citext: citext) -> tsquery`,
	2753: `citext(bytes: bytes) -> citext`,
	2754: `geometry(citext: citext) -> geometry`,
	2755: `void(citext: citext) -> void`,
	2756: `int8(citext: citext) -> int`,
	2757: `record(citext: citext) -> anyelement`,
	2758: `citext(int: int) -> citext`,
	2759: `vector(citext: citext) -> vector`,
	2760: `tsvector(citext: citext) -> tsvector`,
	2761: `jsonb(citext: citext) -> jsonb`,
	2762: `citext(oid: oid) -> citext`,
	2763: `bytes(citext: citext) -> bytes`,
	2764: `timestamp(citext: citext) -> timestamp`,
	2765: `citext(float: float) -> citext`,
	2766: `citext(date: date) -> citext`,
	2767: `refcursor(citext: citext) -> refcursor`,
	2768: `citext(time: time) -> citext`,
	2769: `citext(timestamp: timestamp) -> citext`,
	2770: `citext(timestamptz: timestamptz) -> citext`,
	2771: `citext(interval: interval) -> citext`,
	2772: `citext(timetz: timetz) -> citext`,
	2773: `citext(bit: bit) -> citext`,
	2774: `citext(decimal: decimal) -> citext`,
	2775: `citext(refcursor: refcursor) -> citext`,
	2776: `citext(tuple: tuple) -> citext`,
	2777: `citext(void: void) -> citext`,
	2778: `citext(jsonb: jsonb) -> citext`,
	2779: `citext(varbit: varbit) -> citext`,
	2780: `citext(uuid: uuid) -> citext`,
	2781: `citext(pg_lsn: pg_lsn) -> citext`,
	2782: `citext(tsvector: tsvector) -> citext`,
	2783: `citext(geography: geography) -> citext`,
	2784: `citext(geometry: geometry) -> citext`,
	2785: `citext(tsquery: tsquery) -> citext`,
	...
	2793: `ltreesend(ltree: ltree) -> bytes`,
	2794: `ltreein(input: anyelement) -> ltree`,
	2795: `ltreeout(ltree: ltree) -> bytes`,
	2796: `ltreerecv(input: anyelement) -> ltree`,
	2805: `bpchar(ltree: ltree) -> bpchar`,
	2806: `char(ltree: ltree) -> "char"`,
	2807: `citext(ltree: ltree) -> citext`,
	2808: `name(ltree: ltree) -> name`,
	2809: `text(ltree: ltree) -> string`,
	2810: `varchar(ltree: ltree) -> varchar`,
	2811: `ltree(bpchar: bpchar) -> ltree`,
	2812: `ltree(char: "char") -> ltree`,
	2813: `ltree(citext: citext) -> ltree`,
	2814: `ltree(name: name) -> ltree`,
	2815: `ltree(text: text) -> ltree`,
	2816: `ltree(string: string) -> ltree`,
	2817: `ltree(varchar: varchar) -> ltree`,
	2818: `ltree(ltree: ltree) -> ltree`,
	2819: `max(arg1: ltree) -> anyelement`,
	2820: `min(arg1: ltree) -> anyelement`,
	2821: `array_agg(arg1: ltree) -> ltree[]`,
	2822: `array_cat_agg(arg1: ltree[]) -> ltree[]`,
	2823: `percentile_disc_impl(arg1: float, arg2: ltree) -> ltree`,
	2824: `percentile_disc_impl(arg1: float[], arg2: ltree) -> ltree[]`,
	2825: `array_agg(arg1: ltree[]) -> ltree[][]`,
	2826: `array_append(array: ltree[], elem: ltree) -> ltree[]`,
	2827: `array_positions(array: ltree[], elem: ltree) -> int[]`,
	2828: `array_remove(array: ltree[], elem: ltree) -> anyelement`,
	2829: `array_prepend(elem: ltree, array: ltree[]) -> ltree[]`,
	2830: `array_position(array: ltree[], elem: ltree) -> int`,
	2831: `array_cat(left: ltree[], right: ltree[]) -> ltree[]`,
	2832: `array_replace(array: ltree[], toreplace: ltree, replacewith: ltree) -> anyelement`,
	2833: `array_position(array: ltree[], elem: ltree, start: int) -> int`,
	2834: `first_value(val: ltree) -> ltree`,
	2835: `nth_value(val: ltree, n: int) -> ltree`,
	2836: `lag(val: ltree) -> ltree`,
	2837: `lag(val: ltree, n: int) -> ltree`,
	2838: `lag(val: ltree, n: int, default: ltree) -> ltree`,
	2839: `lead(val: ltree) -> ltree`,
	...
	2845: `ltreesend(ltree: ltree) -> bytes`,
	2846: `ltreein(input: anyelement) -> ltree`,
	2847: `ltreeout(ltree: ltree) -> bytes`,
	2848: `ltreerecv(input: anyelement) -> ltree`,
	2849: `lquerysend(lquery: lquery) -> bytes`,
	2850: `lqueryin(input: anyelement) -> lquery`,
	2851: `lqueryout(lquery: lquery) -> bytes`,
	2852: `lqueryrecv(input: anyelement) -> lquery`,
	2853: `ltxtquerysend(ltxtquery: ltxtquery) -> bytes`,
	2854: `ltxtqueryin(input: anyelement) -> ltxtquery`,
	2855: `ltxtqueryout(ltxtquery: ltxtquery) -> bytes`,
	2856: `ltxtqueryrecv(input: anyelement) -> ltxtquery`,
	2857: `bpchar(ltree: ltree) -> bpchar`,
	2858: `char(ltree: ltree) -> "char"`,
	2859: `citext(ltree: ltree) -> citext`,
	2860: `name(ltree: ltree) -> name`,
	2861: `text(ltree: ltree) -> string`,
	2862: `varchar(ltree: ltree) -> varchar`,
	2863: `ltree(bpchar: bpchar) -> ltree`,
	2864: `ltree(char: "char") -> ltree`,
	2865: `ltree(citext: citext) -> ltree`,
	2866: `ltree(name: name) -> ltree`,
	2867: `ltree(text: text) -> ltree`,
	2868: `ltree(string: string) -> ltree`,
	2869: `ltree(varchar: varchar) -> ltree`,
	2870: `ltree(ltree: ltree) -> ltree`,
	2871: `max(arg1: ltree) -> anyelement`,
	2872: `min(arg1: ltree) -> anyelement`,
	2873: `array_agg(arg1: ltree) -> ltree[]`,
	2874: `array_cat_agg(arg1: ltree[]) -> ltree[]`,
	2875: `percentile_disc_impl(arg1: float, arg2: ltree) -> ltree`,
	2876: `percentile_disc_impl(arg1: float[], arg2: ltree) -> ltree[]`,
	2877: `array_agg(arg1: ltree[]) -> ltree[][]`,
	2878: `array_append(array: ltree[], elem: ltree) -> ltree[]`,
	2879: `array_positions(array: ltree[], elem: ltree) -> int[]`,
	2880: `array_remove(array: ltree[], elem: ltree) -> anyelement`,
	2881: `array_prepend(elem: ltree, array: ltree[]) -> ltree[]`,
	2882: `array_position(array: ltree[], elem: ltree) -> int`,
	2883: `array_cat(left: ltree[], right: ltree[]) -> ltree[]`,
	2884: `array_replace(array: ltree[], toreplace: ltree, replacewith: ltree) -> anyelement`,
	2885: `array_position(array: ltree[], elem: ltree, start: int) -> int`,
	2886: `first_value(val: ltree) -> ltree`,
	2887: `nth_value(val: ltree, n: int) -> ltree`,
	2888: `lag(val: ltree) -> ltree`,
	2889: `lag(val: ltree, n: int) -> ltree`,
	2890: `lag(val: ltree, n: int, default: ltree) -> ltree`,
	2891: `lead(val: ltree) -> ltree`,
	2892: `lead(val: ltree, n: int) -> ltree`,
	2893: `lead(val: ltree, n: int, default: ltree) -> ltree`,
	2894: `last_value(val: ltree) -> ltree`,
	2895: `subltree(ltree: ltree, start: int, end: int) -> ltree`,
	2896: `subpath(ltree: ltree, offset: int, length: int) -> ltree`,
	2897: `subpath(ltree: ltree, offset: int) -> ltree`,
	2898: `nlevel(ltree: ltree) -> int`,
	2899: `index(a: ltree, b: ltree) -> int`,
	2900: `index(a: ltree, b: ltree, offset: int) -> int`,
	2901: `text2ltree(text: string) -> ltree`,
	...
	2929: `st_asmvt(arg1: tuple) -> bytes`,
	2930: `st_asmvt(arg1: tuple, arg2: string) -> bytes`,
	...
	2953: `crdb_internal.txn_feed_partition(stream_id: int, spec: bytes) -> bytes`,
}
