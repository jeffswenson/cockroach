...
import "github.com/cockroachdb/cockroach/pkg/sql/tree"
...
type tableOptions struct {
	...
	primaryIndexFilter         func(*tree.IndexTableDef) bool
	indexFilter                func(*tree.IndexTableDef) bool
}
...
// excluded.
func WithPrimaryIndexFilter(filter func(*tree.IndexTableDef) bool) TableOption {
	return func(o *tableOptions) {
...
func WithIndexFilter(filter func(*tree.IndexTableDef) bool) TableOption {
	return func(o *tableOptions) {
